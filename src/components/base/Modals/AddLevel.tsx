...
interface ModalProps extends FlexProps {
	...
	setLevels: (levels: Array<LevelType>) => void,
};

const AddLevel = ({ onModalClose, isModalOpen, levels, setLevels }: ModalProps) => {
	const { t } = useTranslation('common');

	const [values, setValues] = useState<Array<LevelType>>(levels);
